<template>
    ...
    <footer class="relative bg-blueGray-200 pt-8 pb-6">
        <div class="">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 text-white font-bold text-xs pl-14 py-1" style="background-color: #F37021">
